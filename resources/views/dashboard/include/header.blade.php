...
<a href="{{route('dashboard.index')}}" class="brand-icon d-flex align-items-center mx-2 mx-sm-3 text-primary">
    <img src="{{ url('/') }}/images/dashboard/like4like.png" alt="Like 4 Like" width="عرض_الصورة" height="ارتفاع_الصورة">
</a>
...
<img class="avatar img-thumbnail rounded-circle shadow" src="{{asset('images/dashboard/admins/'.Auth::user()->photo)}}" alt="">
</a>
<div class="dropdown-menu border-0 rounded-4 shadow p-0">
<div class="card border-0 w240">
<div class="card-body border-bottom d-flex">
<img class="avatar rounded-circle" src="{{asset('images/dashboard/admins/'.Auth::user()->photo)}}" alt="">
