    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 d-flex gap-4" style="margin-right:50px ;">
          <li class="nav-item">
            <a class="nav-link active fs-5" aria-current="page" style="color: red" href="home.html">العمل</a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link active fs-5" aria-current="page" href="help.html">المساعده</a>
          </li>
          <li class="nav-item d-lg-block d-none">
          ...
          <li class="nav-item">
            <a class="nav-link active fs-5" aria-current="page" href="profits.html">الارباح</a>
          </li>
        </ul>

        <div class="part-img">
          <img src="assets/user3.jpg" style="width: 36px; height: 36px; border-radius: 50%" alt="" />
        </div>
      </div>
    </div>
  </nav>
